...
public class Functions {
	...
	public static String myf(String [] args) {
		...
		try
		{
			...
			while ((line = reader.readLine()) != null)
			{
				...
				//System.out.println(Integer.parseInt(lineConfig[1]));
				configMap.put(lineConfig[0], Integer.parseInt(lineConfig[1]));
				records.add(line);
			}

			valToReturn = String.valueOf(configMap.get(key)) + ".0";
			reader.close();
	...
	public static String adapter(String [] args) {
		String valToReturn = "";
		...
		List<String> records = new ArrayList<String>();
		Map<String, Integer> configMap = new HashMap<String, Integer>();
		String filename = "adaptation.txt";
		try
		{
			...
			valToReturn = String.valueOf(configMap.get("ada")) + ".0";
